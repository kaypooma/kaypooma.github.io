...
const sounds = [
    // speech
    'you_stupid', 'no_i_not', '21', 'amogus_scream', 'amogus', 'aou', 'bruh', 'deez_nuts', 'flight_cry', 'flight_scream', 'grandma', 'jack_black', 'mammot', 'oh_my_god', 'porch', 'pussy', 'what_da_dog_doin', 'whip',
    '----',
    // sound effects
    'airhorn', 'bonk', 'crowd_laughing', 'dialup', 'dubstep', 'eas_one', 'eas_two', 'epic_fail', 'fl_studio_render', 'fnaf_ambience', 'fnaf_jumpscare', 'geometry_dash', 'ps2_startup', 'ragdoll_sounds', 'role_reveal', 'samsung_notification', 'squeak', 'swoosh', 'vine_boom', 'wii_freeze', 'windows_95', 'windows_xp',
    '----',
    // fart
    'reverb_fart', 'wet_fart', 
    '----',
    // ding buzzer
